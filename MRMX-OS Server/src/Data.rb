...
module RMXOS
	...
	module Data
		...
		BattleNoRequest		= 'You have not accepted the battle request.'
		...
		BattleNoRequest_PLAYER			= '\'PLAYER\' has not accepted the battle request.'
		BattleRequested_PLAYER			= 'You requested to battle with \'PLAYER\'.'
		BattleRequest_PLAYER			= '\'PLAYER\' has requested to battle with you.'		
